...
import ru.neoflex.dossier.enums.Gender;
import ru.neoflex.dossier.enums.MaritalStatus;
...
/**
 * Full client data for statement list.
 *
...
public class ClientDtoFull {
    ...
    private EmploymentDtoFull employment;
