...
public class DocumentServiceImpl implements DocumentService {
    ...
    public void sendDocuments(String statementId) {
        ...
        var emailMessage = EmailMessage.builder()
                ...
                .build();
        kafkaMessagingServiceImpl.sendMessage("send-documents", emailMessage);
    ...
    public void signDocuments(String statementId) {
        ...
        var emailMessage = EmailMessage.builder()
                ...
                .statementId(statementId)
                .build();
        kafkaMessagingServiceImpl.sendMessage("send-ses", emailMessage);
        log.info(SENT_TO_KAFKA, emailMessage);
    }
    ...
    public void verifySesCode(String statementId, String sesCode) {
        ...
        var emailMessage = EmailMessage.builder()
                ...
                .statementId(statementId)
                .build();
        kafkaMessagingServiceImpl.sendMessage("credit-issued", emailMessage);
        log.info(SENT_TO_KAFKA, emailMessage);
    }
