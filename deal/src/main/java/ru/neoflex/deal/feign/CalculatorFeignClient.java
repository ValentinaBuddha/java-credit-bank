...
import ru.neoflex.deal.config.CustomFeignClientConfiguration;
...
@FeignClient(value = "calculator", url = "${calculator.url}", configuration = CustomFeignClientConfiguration.class)
